...
//
//     final relatedNewsModel = relatedNewsModelFromJson(jsonString);

import 'dart:convert';

RelatedNewsModel relatedNewsModelFromJson(String str) => RelatedNewsModel.fromJson(json.decode(str));

String relatedNewsModelToJson(RelatedNewsModel data) => json.encode(data.toJson());
...
class RelatedNewsModel {
  ...
  factory RelatedNewsModel.fromJson(Map<String, dynamic> json) => RelatedNewsModel(
    status: json["status"],
    message: json["message"],
    response: json["response"]==null||json["response"].isEmpty?[]:List<Response>.from(json["response"].map((x) => Response.fromJson(x))),
  );
