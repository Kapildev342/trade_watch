...
part 'single_like_button_event.dart';
part 'single_like_button_state.dart';

class SingleLikeButtonBloc extends Bloc<SingleLikeButtonEvent, SingleLikeButtonState> {
  SingleLikeButtonBloc() : super(SingleLikeButtonListLoadingState()) {
    on<SingleLikeButtonListLoadingEvent>((event, emit) {
      emit(SingleLikeButtonListLoadingState());
    });

    on<SingleLikeButtonListInitialEvent>((event, emit) async {
      ...
      emit(SingleLikeButtonListLoadedState(
