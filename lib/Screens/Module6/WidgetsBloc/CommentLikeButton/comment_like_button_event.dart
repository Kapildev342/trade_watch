...
class CommentLikeButtonEvent extends Equatable {
  const CommentLikeButtonEvent();
...
class CommentLikeButtonListLoadingEvent extends CommentLikeButtonEvent{

  const CommentLikeButtonListLoadingEvent();
...
class CommentLikeButtonListInitialEvent extends CommentLikeButtonEvent {
  final String id;
  ...
  const CommentLikeButtonListInitialEvent({
    required this.id,
