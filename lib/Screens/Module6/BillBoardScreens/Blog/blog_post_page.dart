...
class _BlogPostPageState extends State<BlogPostPage> {
  ...
  @override
  void initState() {
    getAllDataMain(name: 'Blog_Creation_Page');
    super.initState();
  }
                      ...
                      child: Row(
                        ...
                        children: [
                          billboardWidgetsMain.getProfile(
                              context: context, heightValue: height / 14.93, widthValue: width / 7.08, myself: true, userId: '', isProfile: "user"),
                          SizedBox(
                            width: height / 56.26,
                          ),
                          Column(
                                      ...
                                      customRenders: {
                                        imageTagMatcher(): CustomRender.widget(
                                            widget: (context, buildChildren) => Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    image:
                                                        DecorationImage(image: NetworkImage(context.tree.attributes["src"] ?? ""), fit: BoxFit.fill),
                                                    borderRadius: BorderRadius.circular(15),
                                                  ),
                            ...
                            children: [
                                  ...
                                  children: [
                                    ...
                                    /*Container(
                                      ...
                                      child: CheckboxListTile(
                                        ...
                                        contentPadding: EdgeInsets.symmetric(horizontal: 0,vertical: 0.0),
                                        dense: true,
                                        title: Text("Private",style: TextStyle(fontWeight: FontWeight.w500,
                                            fontSize: 12),),
                                      ),
                                    ),*/
                                  ],
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  onChanged: (value) {
                                    setState(() {
                                      validTitle = value.isEmpty ? true : RegExp(r"([a-zA-Z])").hasMatch(value);
                                    });
                                  },
                              ...
                              validTitle
                                  ...
                                  : Padding(
                                      ...
                                      child: const Row(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        children: [
                                          Text("Should at least contain one alphabet.", style: TextStyle(fontSize: 10, color: Colors.red)),
                                        ],
                                      ),
                                    ),
                              SizedBox(
                              ...
                              Container(
                                ...
                                child: HtmlEditor(
                                  ...
                                  callbacks: Callbacks(
                                      ...
                                      onBlurCodeview: () {},
                                      onInit: () {
                                        htmlController.insertHtml(inputString);
                                      },
