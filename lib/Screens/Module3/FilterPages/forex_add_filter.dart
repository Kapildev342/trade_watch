...
class ForexAddFilterPage extends StatefulWidget {
  final String text;
  final String page;

  const ForexAddFilterPage({
    Key? key,
    required this.text,
    required this.page,
  }) : super(key: key);
  ...
  @override
  State<ForexAddFilterPage> createState() => _ForexAddFilterPageState();
}

class _ForexAddFilterPageState extends State<ForexAddFilterPage> {
                                                              ...
                                                              return CheckboxListTile(
                                                                ...
                                                                onChanged: (bool? value) {
                                                                  ...
                                                                  /*  if(sendTickersList.length==1){
                                                                    _forexTickersController.text=sendTickersNameList[0];
