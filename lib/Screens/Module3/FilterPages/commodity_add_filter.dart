...
class CommodityAddFilterPage extends StatefulWidget {
  final String text;
  final String page;

  const CommodityAddFilterPage({
    Key? key,
    required this.text,
    required this.page,
  }) : super(key: key);
  ...
  @override
  State<CommodityAddFilterPage> createState() => _CommodityAddFilterPageState();
}

class _CommodityAddFilterPageState extends State<CommodityAddFilterPage> with WidgetsBindingObserver {
                    ...
                    children: [
                      ...
                      ListTile(
                        onTap: indusSelect
                                                                ...
                                                                onTap: () async {
                                                                  if (tickerSelectAll) {
                                                                    ...
                                                                    if (sendTickersList.length == 1) {
                                                                      _commodityTickersController.text = sendTickersNameList[0];
                            ...
                            : () {
                                Flushbar(
                                  message: "Please select anyone Country",
