...
ResponseFeatureResponseModel responseFeatureResponseModelFromJson(String str) => ResponseFeatureResponseModel.fromJson(json.decode(str));

String responseFeatureResponseModelToJson(ResponseFeatureResponseModel data) => json.encode(data.toJson());

class ResponseFeatureResponseModel {
  final bool status;
  final List<Response> response;
  final String message;

  ResponseFeatureResponseModel({
    required this.status,
    required this.response,
    required this.message,
  });

  factory ResponseFeatureResponseModel.fromJson(Map<String, dynamic> json) => ResponseFeatureResponseModel(
        status: json["status"],
