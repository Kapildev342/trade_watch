...
class ExpandableFabState extends State<ExpandableFab>
  ...
  void initState() {
    ...
    _openButtonBuilder = widget.openButtonBuilder ?? RotateFloatingActionButtonBuilder(
          child: const Icon(Icons.add),
        );
    _closeButtonBuilder = widget.closeButtonBuilder ?? DefaultFloatingActionButtonBuilder(
      backgroundColor:Color(0XFFD7FFD4),
      foregroundColor:Color(0XFFD7FFD4),
          fabSize: ExpandableFabSize.small,
          child: const Icon(Icons.close,color: Color(0XFF6A6A6A),),
        );
  }
