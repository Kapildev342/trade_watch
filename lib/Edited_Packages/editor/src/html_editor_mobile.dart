import 'package:tradewatchfinal/Edited_Packages/editor/html_editor.dart' hide HtmlEditorController;
import 'package:tradewatchfinal/Edited_Packages/editor/src/html_editor_controller_mobile.dart';
import 'package:tradewatchfinal/Edited_Packages/editor/src/widgets/html_editor_widget_mobile.dart';
...
class HtmlEditor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (!kIsWeb) {
      ...
      return const Text(
          'Flutter Web environment detected, please make sure you are importing package:tradewatchfinal/Functions/editor/html_editor.dart');
    }
  }
}
