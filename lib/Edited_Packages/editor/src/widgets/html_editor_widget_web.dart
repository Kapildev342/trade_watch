...
import 'package:tradewatchfinal/Edited_Packages/editor/utils/shims/dart_ui.dart' as ui;
...
class _HtmlEditorWidgetWebState extends State<HtmlEditorWidget> {
  ...
  void initSummernote() async {
    ...
    if ((Theme.of(widget.initBC).brightness == Brightness.dark || widget.htmlEditorOptions.darkMode == true) &&
      ...
      darkCSS = '<link href=\"assets/lib/Functions/editor/assets/summernote-lite-dark.css\" rel=\"stylesheet\">';
    }
    var jsCallbacks = '';
    if (widget.callbacks != null) {
    ...
    """;
    var filePath = 'packages/lib/Functions/editor/assets/summernote-no-plugins.html';
    ...
    htmlString = htmlString
        ...
        .replaceFirst('"jquery.min.js"', '"assets/lib/Functions/editor/assets/jquery.min.js"')
        .replaceFirst('"summernote-lite.min.css"', '"assets/lib/Functions/editor/assets/summernote-lite.min.css"')
        .replaceFirst('"summernote-lite.min.js"', '"assets/lib/Functions/editor/assets/summernote-lite.min.js"');
