...
import 'package:tradewatchfinal/Edited_Packages/editor/utils/utils.dart';
...
class ToolbarWidgetState extends State<ToolbarWidget> {
  ...
  void disable() {
    setStateEditor(mounted, this.setState, () {
      _enabled = false;
    });
  }
        ...
        child: AbsorbPointer(
          ...
          child: Opacity(
            ...
            child: Padding(
              ...
              child: Wrap(
                runSpacing: 1, //widget.htmlToolbarOptions.gridViewVerticalSpacing,
                spacing: 1, //widget.htmlToolbarOptions.gridViewHorizontalSpacing,
        ...
        toolbarChildren.add(Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton2<String>(
              ...
              offset: const Offset(10, 350),*/
              items: [
                DropdownMenuItem(value: 'p', child: PointerInterceptor(child: const Text('Normal', style: TextStyle(fontSize: 12)))),
                DropdownMenuItem(
                    value: 'blockquote',
                    child: PointerInterceptor(
                      child: Container(
                          decoration: const BoxDecoration(border: Border(left: BorderSide(color: Colors.grey, width: 3.0))),
                          padding: const EdgeInsets.symmetric(horizontal: 10.0),
                          child: const Text('Quote', style: TextStyle(fontFamily: 'times', color: Colors.grey, fontSize: 12))),
                    )),
                DropdownMenuItem(
                    value: 'pre',
                    child: PointerInterceptor(
                      child: Container(
                          ...
                          padding: const EdgeInsets.symmetric(horizontal: 10.0),
                          child: const Text('Code', style: TextStyle(fontFamily: 'courier', color: Colors.white, fontSize: 12))),
                    )),
                DropdownMenuItem(
                  value: 'h1',
                  child: PointerInterceptor(child: const Text('Header', style: TextStyle(fontSize: 12))),
                ),
                DropdownMenuItem(
                  value: 'h2',
                  child: PointerInterceptor(child: const Text('Title', style: TextStyle(fontSize: 12))),
                ),
                DropdownMenuItem(
                  value: 'h3',
                  child: PointerInterceptor(child: const Text('Title mini', style: TextStyle(fontSize: 12))),
                ),
                DropdownMenuItem(
                  value: 'h4',
                  child: PointerInterceptor(child: const Text('Subtitle', style: TextStyle(fontSize: 12))),
                ),
                DropdownMenuItem(
                  value: 'h5',
                  child: PointerInterceptor(child: const Text('Subtitle mini', style: TextStyle(fontSize: 12))),
                ),
                DropdownMenuItem(
                  value: 'h6',
                  child: PointerInterceptor(child: const Text('Subtitle micro', style: TextStyle(fontSize: 12))),
                ),
              ],
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons2()[index].icon == Icons.format_strikethrough) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.strikethrough, _miscFontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons2()[index].icon == Icons.superscript) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.superscript, _miscFontSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons2()[index].icon == Icons.subscript) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.subscript, _miscFontSelected[index], updateStatus) ?? true;
                if (proceed) {
          ...
          onPressed: (int index) async {
            ...
            if (_colorSelected[index]) {
              if (t.getIcons()[index].icon == Icons.format_color_text) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.foregroundColor, _colorSelected[index], updateStatus) ?? true;
                if (proceed) {
                  widget.controller
                      .execCommand('foreColor', argument: (Colors.black.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                  updateStatus(null);
                }
              }
              if (t.getIcons()[index].icon == Icons.format_color_fill) {
                ...
                if (proceed) {
                  widget.controller
                      .execCommand('hiliteColor', argument: (Colors.yellow.value & 0xFFFFFF).toRadixString(16).padLeft(6, '0').toUpperCase());
                  updateStatus(null);
                }
              }
            } else {
                      ...
                      return PointerInterceptor(
                        child: AlertDialog(
                          ...
                          content: ColorPicker(
                            ...
                            title: Text('Choose a Color', style: Theme.of(context).textTheme.bodySmall),
                            width: 40,
                            height: 40,
                            spacing: 0,
                            runSpacing: 0,
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_left) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignLeft, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_center) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignCenter, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_right) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignRight, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
              ...
              if (t.getIcons1()[index].icon == Icons.format_align_justify) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.alignJustify, _alignSelected[index], updateStatus) ?? true;
                if (proceed) {
          ...
          toolbarChildren.add(Container(
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<double>(
                ...
                style: widget.htmlToolbarOptions.textStyle,
                items: [
                  CustomDropdownMenuItem(value: 1, child: PointerInterceptor(child: const Text('1.0'))),
                  CustomDropdownMenuItem(
                    value: 1.2,
                  ...
                  CustomDropdownMenuItem(value: 3, child: PointerInterceptor(child: const Text('3.0'))),
                ],
                ...
                onChanged: (double? changed) async {
                  ...
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.lineHeight, changed, updateSelectedItem) ?? true;
                    if (proceed) {
                      if (kIsWeb) {
                          ...
                          return AlertDialog(
                            ...
                            content: Form(
                              ...
                              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                const Text('Text to display', style: TextStyle(fontWeight: FontWeight.bold)),
                        ...
                        child: StatefulBuilder(builder: (BuildContext context, StateSetter setState) {
                          return AlertDialog(
                            ...
                            content: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                              const Text('Select from files', style: TextStyle(fontWeight: FontWeight.bold)),
                              const SizedBox(height: 10),
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(backgroundColor: const Color(0XFF0EA102), elevation: 1.0),
                                onPressed: () async {
                                ...
                                child: const Text('Choose image', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                              ),
                              const SizedBox(
                                height: 5,
                              ),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    Navigator.of(context).pop();
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaUploadInterceptor?.call(result!.files.single, InsertFileType.image) ??
                                            true;
                                    if (proceed) {
                                      String imagePath = await billBoardApiMain.fileUploadBillBoard(file: file!, context: context);
                                      widget.controller.insertHtml(
                                          '<img style="width: 360px; height: 200px; border-radius: 15px" src="$imagePath" data-filename="${result!.files.single.name}"/>');
                                    }
                                  } else {
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.image) ?? true;
                                    if (proceed) {
                          ...
                          return AlertDialog(
                            ...
                            content: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              ElevatedButton(
                                ...
                                child: const Text('Choose audio', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                              ),
                              const SizedBox(
                                height: 5,
                              ),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    Navigator.of(context).pop();
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaUploadInterceptor?.call(result!.files.single, InsertFileType.audio) ??
                                            true;
                                    if (proceed) {
                                      String audioPath = await billBoardApiMain.fileUploadBillBoard(file: file!, context: context);
                                      widget.controller.insertHtml(
                                          '<audio controls src="$audioPath" data-filename="${result!.files.single.name}" style="width: 340px; height: 50px; border-radius: 25px"/audio>');
                                    }
                                    /* var base64Data = base64.encode(result!.files.single.bytes!);
                                    var proceed = await widget.htmlToolbarOptions.mediaUploadInterceptor
                                    ?.call(result!.files.single, InsertFileType.audio) ?? true;
                                    if (proceed) {
                                      widget.controller.insertHtml(
                                    ...
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.audio) ?? true;
                                    if (proceed) {
                          ...
                          return AlertDialog(
                            ...
                            content: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              ElevatedButton(
                                ...
                                child: const Text('Choose video', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                              ),
                              const SizedBox(
                                height: 5,
                              ),
                              ...
                              TextButton(
                                onPressed: () async {
                                  if (filename.text.isEmpty && url.text.isEmpty) {
                                    ...
                                    Navigator.of(context).pop();
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaUploadInterceptor?.call(result!.files.single, InsertFileType.video) ??
                                            true;
                                    if (proceed) {
                                      String videoPath = await billBoardApiMain.fileUploadBillBoard(file: file!, context: context);
                                      widget.controller.insertHtml(
                                          '<video controls src="$videoPath" data-filename="${result!.files.single.name}" style="width: 360px; height: 200px; border-radius: 15px"/video>');
                                    }
                                    ...
                                    var proceed =
                                        await widget.htmlToolbarOptions.mediaLinkInsertInterceptor?.call(url.text, InsertFileType.video) ?? true;
                                    if (proceed) {
          ...
          toolbarChildren.add(ToggleButtons(
            ...
            onPressed: (int index) async {
              ...
              if (t.getIcons1()[index].icon == Icons.fullscreen) {
                var proceed =
                    await widget.htmlToolbarOptions.onButtonPressed?.call(ButtonType.fullscreen, _miscSelected[index], updateStatus) ?? true;
                if (proceed) {
            ...
            child: CustomDropdownButtonHideUnderline(
              child: CustomDropdownButton<String>(
                ...
                onChanged: (String? changed) async {
                  ...
                  if (changed != null) {
                    var proceed =
                        await widget.htmlToolbarOptions.onDropdownChanged?.call(DropdownType.listStyles, changed, updateSelectedItem) ?? true;
                    if (proceed) {
                      if (kIsWeb) {
