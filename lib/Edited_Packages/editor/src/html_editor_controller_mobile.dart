...
import 'package:tradewatchfinal/Edited_Packages/editor/src/html_editor_controller_unsupported.dart'
    as unsupported;
...
class HtmlEditorController extends unsupported.HtmlEditorController {
  ...
  void reloadWeb() {
    throw Exception(
        'Non-Flutter Web environment detected, please make sure you are importing package:tradewatchfinal/Functions/editor/html_editor.dart and check kIsWeb before calling this function');
  }
