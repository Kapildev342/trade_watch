...
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/category_emoji.dart';
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/config.dart';
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/default_emoji_picker_view.dart';
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/default_emoji_set.dart';
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/emoji.dart';
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/emoji_picker_internal_utils.dart';
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/emoji_view_state.dart';
import 'package:tradewatchfinal/Edited_Packages/emojiPicker/src/recent_emoji.dart';
...
class EmojiPickerState extends State<EmojiPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.customWidget == null ? DefaultEmojiPickerView(widget.config, _state) : widget.customWidget!(widget.config, _state);
  }
  ...
  Future<void> _updateEmojis() async {
    ...
    _categoryEmoji.addAll(widget.config.checkPlatformCompatibility ? await _emojiPickerInternalUtils.filterUnsupported(data) : data);
